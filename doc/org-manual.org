...
- ~multipage-split-function~ ::

  #+vindex: multipage-split-function
  The function to call when multipage output is requested.

  This function is called on the final parse tree.  The function has
