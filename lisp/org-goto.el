...
(defun org-goto--set-map ()
  ...
  (setq org-goto-map
	(let ((map (make-sparse-keymap)))
	  ...
	  (org-defkey map [(down)] 'org-next-visible-heading)
	  (org-defkey map [(up)] 'org-previous-visible-heading)
	  (if org-goto-auto-isearch
              (define-key-after map [t] 'org-goto-local-auto-isearch)
            (org-defkey map "q" 'org-goto-quit)
	    (org-defkey map "n" 'org-next-visible-heading)
	    (org-defkey map "p" 'org-previous-visible-heading)
	  ...
	  (org-defkey map "\C-c\C-n" 'org-next-visible-heading)
	  (org-defkey map "\C-c\C-p" 'org-previous-visible-heading)
